...
<head>
<meta charset="UTF-8">
<title>3D Подарочный купон</title>
<style>
...
<div id="ui">
  <b>Лицевая сторона:</b><br>
  <textarea id="front">🎁 ПОДАРОЧНЫЙ КУПОН</textarea><br>

  <b>Обратная сторона:</b><br>
  <textarea id="back">Действителен до 31.12.2025</textarea><br>

  <b>Размер шрифта:</b><br>
  <input id="font" type="number" value="40">
</div>

<!-- ПРАВИЛЬНЫЕ версии Three.js и OrbitControls -->
...
<script>
  ...
  function draw(ctx, text, fontSize) {
    ctx.fillStyle = "#fff5dd";          // цвет бумаги
    ctx.fillRect(0, 0, W, H);

    ctx.fillStyle = "#b22222";          // цвет текста
